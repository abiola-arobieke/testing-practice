...
**To Do List** is a Simple Project to Practice Testing
...
```sh
  git clone https://github.com/abiola-arobieke/testing-practice.git
```
...
Feel free to check the [issues page](https://github.com/abiola-arobieke/testing-practice/issues).
